...
public class GerenciadorDeSessoesTest {
	...
	public void garanteQueNaoDevePermitirSessaoNoMesmoHorario(){
		...
		Assert.assertFalse(gerenciadorDeSessoes.cabe(sessaoDasDez));
	}
	...
	public void garanteQueNaoDevePermitirSessaoTerminandoDentroDoHorarioDeUmaSessaoJaExistente(){
		...
		GerenciadorDeSessoes gerenciadorDeSessoes = new GerenciadorDeSessoes(sessoes);
		Assert.assertFalse(gerenciadorDeSessoes.cabe(sessao));
	}
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes(){
		...
		GerenciadorDeSessoes gerenciadorDeSessoes = new GerenciadorDeSessoes(sessoes);
		System.out.println(gerenciadorDeSessoes.cabe(sessaoDasTreze));
		Assert.assertTrue(gerenciadorDeSessoes.cabe(sessaoDasTreze));
	}
